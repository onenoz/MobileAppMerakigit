    ...
    <div class="container-xxl bg-white p-0">
        ...
        <div class="container-xxl py-5">
            <div class="container py-5 px-lg-5">
                <div class="row g-4 gap-3 justify-content-center" id="berita-container">
                    @foreach($news as $lstberita)
                        <div class="col-lg-3 col-md-6 card" style="width: 18rem;">
                            <p class="card-img-top">{{ $lstberita->image }}</p>
                            <div class="card-body d-flex flex-column">
                                <p class="card-text">{{ $lstberita-> title }}</p>
                                <a href="DetailBerita/{{$lstberita->id}}" class="btn btn-card mt-auto"><b>Selengkapnya</b></a>
                            </div>
                        </div>
                    @endforeach
                </div>
